...
зі спеціальністю (position) 'frontend developer' або (OR) 'backend developer'.
Колонка з департаментом у результаті повинна мати назву department_name, а колонка з кількістю — count.
