...
(
    ...
    `annual_revenue_billions` INT          not null
);
...
values (2, 'Applecrumble & Fish', 'USA', 'af.com', 100500),
       ...
       (8, 'Beanz', 'USA', 'beanz.com', 28),
       (3, 'Unigear', 'UK', 'unigear.com', 43),
       (1, 'Nest', 'Switzerland', 'nest.com', 90),
       (10, 'Pepcola', 'USA', 'pepcola.com', 21),
       (12, 'KMWO Co.', 'China', 'kmwo.com', 9),
       ...
       (7, 'Random International', 'USA', 'random.com', 37)
;