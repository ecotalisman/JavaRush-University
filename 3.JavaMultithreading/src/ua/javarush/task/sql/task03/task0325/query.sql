...
1. Вибрати стовпчик zip_code з таблиці customers і стовпчик order_id з таблиці orders.
...
4. Використовуючи оператор WHERE, додати умову, що shipped_date таблиці orders IS NOT NULL, і за допомогою оператора AND вказати,
